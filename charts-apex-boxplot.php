...
<head>
    <title>Apex BoxPlot Chart | Attex - Bootstrap 5 Admin & Dashboard Template</title>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">BoxPlot Chart</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">BoxPlot Chart</h4>
                            </div>
                        </div>
                    </div>
