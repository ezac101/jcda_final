...
<head>
    <title>Widgets | Attex - Bootstrap 5 Admin & Dashboard Template</title>
...
<body>
                            ...
                            <div class="card cta-box text-bg-info">
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <img class="my-3" src="assets/images/svg/startman.svg" width="138" alt="Generic placeholder image">
    ...
    <!-- Chat js -->
    <script src="../assets/js/pages/component.chat.js"></script>

    <script src="assets/vendor/daterangepicker/moment.min.js"></script>

    <!-- Todo js -->
    <script src="assets/js/pages/component.todo.js"></script>
